...
const SEED_IDENTITIES = [
  ...
  { person_id: 'ID-0020', display_name: 'Akash Verma', email: 'akash.verma@identitysphere.ai', department: 'Engineering', title: 'Full Stack Developer', type: 'Human', status: 'Active', platforms: ['active_directory', 'okta', 'github'], risk_score: 31.2, severity: 'medium', is_admin: false, mfa_complete: true, max_dormancy_days: 3, platform_count: 3, group_count: 3, role_count: 3, entitlement_count: 8 },
  { person_id: 'ID-0021', display_name: 'svc-cicd-pipeline', email: 'svc-cicd@identitysphere.ai', department: 'Engineering', title: 'CI/CD Service Account', type: 'Service', status: 'Active', platforms: ['aws_iam', 'github'], risk_score: 56.2, severity: 'high', is_admin: false, mfa_complete: false, max_dormancy_days: 0, platform_count: 2, group_count: 1, role_count: 2, entitlement_count: 8 },
...
const SEED_BLAST_RADII = [
  ...
  { identity: 'Raghu Krishnan', id: 'ID-0001', severity: 'critical', resources: 14, permissions: 18, adminRoles: 2, platforms: ['active_directory', 'aws_iam', 'okta', 'github'], byPlatform: { active_directory: 4, aws_iam: 4, okta: 3, github: 3 } },
  ...
  { identity: 'Arjun Reddy', id: 'ID-0003', severity: 'high', resources: 11, permissions: 22, adminRoles: 1, platforms: ['active_directory', 'aws_iam', 'okta', 'github'], byPlatform: { active_directory: 3, aws_iam: 3, okta: 2, github: 3 } },
...
const SEED_LIFECYCLE = [
  { id: 'JML-001', type: 'joiner', identity: 'Karthik Nair', department: 'Engineering', date: '2026-06-19', status: 'completed', platforms: ['active_directory', 'okta', 'github'], actions: ['AD account created', 'Okta SSO configured', 'GitHub access granted'], approver: 'Pradeep M' },
  ...
  { id: 'JML-004', type: 'leaver', identity: 'Meera Iyer', department: 'Engineering', date: '2026-06-16', status: 'pending_review', platforms: ['active_directory', 'github'], actions: ['Pending: AD disable', 'Pending: GitHub remove'], approver: null },
  { id: 'JML-005', type: 'joiner', identity: 'Suraj Patil', department: 'Security', date: '2026-06-20', status: 'in_progress', platforms: ['active_directory', 'aws_iam', 'okta', 'github'], actions: ['AD account created', 'AWS IAM provisioning...', 'Okta SSO pending', 'GitHub pending'], approver: 'Pradeep M' },
];
...
const SEED_ACCESS_REVIEWS = [
  {
    ...
    items: [
      ...
      { id: 'REV-006', identity: 'Sandeep Kumar', personId: 'ID-0010', department: 'DevOps', platform: 'github', role: 'Owner', riskScore: 58.4, severity: 'high', status: 'pending' },
