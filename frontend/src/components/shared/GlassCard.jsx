/**
 * Glass card — no framer-motion entry animation (instant render for smooth nav).
 * Hover effect via CSS only.
 */
export default function GlassCard({
  ...
  return (
    <div
      id={id}
      onClick={onClick}
      className={`glass-card relative rounded-xl ${padding} transition-colors duration-200 ${hover || onClick ? 'cursor-pointer' : ''} ${className}`}
      style={{
