...
export const IDENTITY_GRAPH_NODES = [
  ...
  { id: '4', type: 'account', data: { label: 'raghu-k', platform: 'github' }, position: { x: 500, y: 150 } },
  ...
  { id: '10', type: 'role', data: { label: 'Admin', platform: 'github' }, position: { x: 550, y: 300 } },
  ...
  { id: '14', type: 'permission', data: { label: 'admin:repos:private', platform: 'github' }, position: { x: 530, y: 450 } },
  ...
  { id: '18', type: 'resource', data: { label: 'repos:private', platform: 'github' }, position: { x: 530, y: 580 } },
